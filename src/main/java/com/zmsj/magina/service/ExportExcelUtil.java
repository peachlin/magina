...
public class ExportExcelUtil<T> {
  ...
  /**
   * 通用Excel导出方法,利用反射机制遍历对象的所有字段，将数据写入Excel文件中 <br> 此版本生成2007以上版本的文件 (文件后缀：xlsx)
   *
   * @param sheetName 表格标题名
   * @param headers 表格头部标题集合
   ...
   */
  public void exportExcel(Workbook workbook, String sheetName, String[] headers, Collection<T> dataset,
